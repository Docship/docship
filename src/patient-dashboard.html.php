...
<head>
  ...
  <link href="public/css/dashboard.patient.css" rel="stylesheet">
</head>

<body>

  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-4" href="#">DocShip</a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" id="appointments">
                <span data-feather="calendar"></span>
                Appointments
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" id="doctors">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#" id="prescriptions">
      ...
      <!-- Home -->
      <main role="main" class="home col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
      ...
      <!-- Appointments -->
      <main role="main" class="appointments invisible col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <!-- Doctors -->
      <main role="main" class="doctors invisible col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <!-- Messages -->
      <main role="main" class="messages invisible col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <!-- Prescriptions -->
      <main role="main" class="prescriptions invisible col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <!-- Settings -->
      <main role="main" class="settings invisible col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div
          class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <script src="public/js/dashboard.patient.js"></script>
</body>
