                ...
                <div class="p-3 py-1">
                    <div class="row">
                        <div class="col-lg-6 mt-2">
                          <input type="text" class="form-control" placeholder="First name" value="Nirmal">
                          <div><?php ?></div>
                        </div>
                        <div class="col-lg-6 mt-2">
                          <input type="text" class="form-control" placeholder="Last name" value="Sankalana" >
                          <div></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 mt-2">
                          <input type="email" class="form-control" placeholder="Email" value="sankalana.nirmal@gmail.com">
                          <div></div>
                        </div>
                        <div class="col-lg-6 mt-2">
                          <input type="tel" class="form-control" placeholder="Phone number" value="+940776048702" >
                          <div></div>
                        </div>
                    </div>
                    <div class="row">
