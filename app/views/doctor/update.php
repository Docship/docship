    ...
    <div class="row">
      <div class="col-lg-4 border-right">
        <div class="d-flex flex-column align-items-center text-center py-5">
          ...
          <span class="font-weight-bold">Dr. <?php echo $data['fname'] ?></span>
      ...
      <div class="col-lg-8">
        <div class="p-3 py-1">
          <form id="myform" method="post" action="<?php echo URLROOT; ?>/doctor/update">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 mt-2">
                <input name="repassword" type="password" class="form-control update-inputs update-patient"
                  placeholder="Re Type your password" value=<?php echo $data['repassword'] ?>>
                  <div><?php 
            ...
            <div class="row">
              <div class="col-lg-6 mt-2">
                <input name="bday" placeholder="Birthday" name="bday" class="form-control shadow-none update-patient update-inputs" id="bday"
