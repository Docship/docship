        ...
        <script src="<?php echo URLROOT; ?>/js/appointment_button.js"></script>
          <div class="form-row mx-2 mb-2">
            ...
            <select id="search" class="custom-select">
                ...
                <option value="name-of-pat" selected>Search by Name</option>
                <option value="app-date">Search by Date</option>
                <option value="app-tele">Search by Telephone No</option>
              </select>
            </div>
          ...
          if(isset($data['appointments'])){
            if(!empty($data['appointments'])){
              ...
              foreach($data['appointments'] as $appointment){
                ...
                $r4 = "<td class='name-of-pat'>" . $appointment['firstname'] . "</td>";
                $r5 = "<td class='app-tele'>" . $appointment['telephone'] . "</td>";
